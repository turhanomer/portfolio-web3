...
const awards = [
  {
    place: 'Birincilik',
    icon: '🥇',
    title: 'Dijital Deprem Çözümleri Hackathonu',
    issuer: 'Bursa Teknik Üniversitesi',
    date: 'May 2025',
  ...
  },
  {
    place: 'Birincilik',
    icon: '🥇',
    title: 'GSB Ünides: Dijital Dönüşüm Atölyesi Ar-Ge ile Geleceği Kodla Hackathonu',
    issuer: '',
    date: 'Haz 2025',
    color: 'var(--btc-orange)'
  },
  {
    place: 'Üçüncülük',
    icon: '🥉',
    title: 'Sui Foundation Hackathon',
    issuer: 'Mysten Labs',
    date: 'Kas 2025',
    color: '#cd7f32' // bronze
  }
    ...
    <section id="awards" style={{ padding: '80px 5%', position: 'relative', zIndex: 10 }}>
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '40px', justifyContent: 'flex-end' }}>
          <div style={{ height: '1px', flex: 1, background: 'linear-gradient(270deg, rgba(255,255,255,0.1) 0%, transparent 100%)' }}></div>
          <h2 style={{ fontSize: '2rem', margin: 0, textAlign: 'right' }}>
            Airdrops / Ödüller <span className="mono-text" style={{ fontSize: '1rem', color: 'var(--text-muted)' }}>(Başarılar)</span>
          </h2>
        </div>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: '250px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '5px', flexWrap: 'wrap' }}>
                  ...
                  <span className="mono-text" style={{ padding: '2px 8px', background: `${award.color}20`, color: award.color, borderRadius: '12px', fontSize: '0.7rem' }}>
                    {award.place}
                  </span>
                </div>
